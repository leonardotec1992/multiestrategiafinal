...
class Report2026HighFreqSimulator:
    def __init__(self, ticker, initial_balance=1000.0, base_lot=0.01, max_layers=4, shield_pct=4.0):
        ...
        # High frequency / High Win Rate Parameters
        self.tp_pips = 20.0
        self.sl_pips = 16.0
        self.be_pips = 8.0
        self.be_lock_pips = 2.0
        self.trail_start_pips = 12.0
        self.trail_step_pips = 4.0
        self.grid_step_pips = 14.0
    ...
    def fetch_2026_m15_data(self):
        # Fetch 60d M15 data covering recent 2026 months
    ...
    def run_2026_monthly_simulation(self):
        df = self.fetch_2026_m15_data()
...
if __name__ == '__main__':
    ...
    print("=" * 110)
    print("      REPORTE DETALLADO MES POR MES DE 2026 - ALTA FRECUENCIA Y ALTO WIN RATE")
    print("      RoboForex / Libertex ECN | Spreads: 1.2 - 1.6 pips | Comisión: $3.50/lote")
    print("=" * 110)

    for pair in pairs:
        pair_clean = pair.replace('=X', '')
        sim = Report2026HighFreqSimulator(ticker=pair, initial_balance=1000.0)
        reports = sim.run_2026_monthly_simulation()
        ...
        print(f"RESUMEN 2026 {pair_clean}: Beneficio Neto: {tot_sign}${tot_net:.2f} ({(tot_net/1000.0)*100:.2f}%) | Trades: {tot_tr}")
        print("=" * 110)
